...
values (100, 0, '0', 'CodeAssistant科技', 0, '正则表达式', '15888888888', 'codeAssistant@qq.com', '0', '0', 'admin',
        sysdate(), '', null);
insert into sys_dept
values (101, 100, '0,100', '深圳总公司', 1, '正则表达式', '15888888888', 'codeAssistant@qq.com', '0', '0', 'admin',
        sysdate(), '', null);
insert into sys_dept
values (102, 100, '0,100', '长沙分公司', 2, '正则表达式', '15888888888', 'codeAssistant@qq.com', '0', '0', 'admin',
        sysdate(), '', null);
insert into sys_dept
values (103, 101, '0,100,101', '研发部门', 1, '正则表达式', '15888888888', 'codeAssistant@qq.com', '0', '0', 'admin',
        sysdate(), '', null);
insert into sys_dept
values (104, 101, '0,100,101', '市场部门', 2, '正则表达式', '15888888888', 'codeAssistant@qq.com', '0', '0', 'admin',
        sysdate(), '', null);
insert into sys_dept
values (105, 101, '0,100,101', '测试部门', 3, '正则表达式', '15888888888', 'codeAssistant@qq.com', '0', '0', 'admin',
        sysdate(), '', null);
insert into sys_dept
values (106, 101, '0,100,101', '财务部门', 4, '正则表达式', '15888888888', 'codeAssistant@qq.com', '0', '0', 'admin',
        sysdate(), '', null);
insert into sys_dept
values (107, 101, '0,100,101', '运维部门', 5, '正则表达式', '15888888888', 'codeAssistant@qq.com', '0', '0', 'admin',
        sysdate(), '', null);
insert into sys_dept
values (108, 102, '0,100,102', '市场部门', 1, '正则表达式', '15888888888', 'codeAssistant@qq.com', '0', '0', 'admin',
        sysdate(), '', null);
insert into sys_dept
values (109, 102, '0,100,102', '财务部门', 2, '正则表达式', '15888888888', 'codeAssistant@qq.com', '0', '0', 'admin',
        sysdate(), '', null);
...
values (1, 103, 'admin', '正则表达式', '00', 'assistant@163.com', '15888888888', '1', '',
...
values ('1', '温馨提醒：2018-07-01 代码助手新版本发布啦', '2', '新版本内容', '0', 'admin', sysdate(), '', null,
        '管理员');
insert into sys_notice
values ('2', '维护通知：2018-07-01 代码助手系统凌晨维护', '1', '维护内容', '0', 'admin', sysdate(), '', null, '管理员');
