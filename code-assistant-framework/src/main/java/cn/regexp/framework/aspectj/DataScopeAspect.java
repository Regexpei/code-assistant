...
import cn.regexp.framework.security.context.PermissionContextHolder;
...
public class DataScopeAspect {
    ...
    public static void dataScopeFilter(JoinPoint joinPoint, SysUser user, String deptAlias, String userAlias,
        ...
        user.getRoles().forEach(role -> {
            if (DATA_SCOPE_CUSTOM.equals(role.getDataScope()) && StringUtils.containsAny(role.getPermissions(),
